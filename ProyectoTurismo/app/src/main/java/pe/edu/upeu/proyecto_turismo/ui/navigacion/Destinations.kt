...
sealed class Destinations(
    ...
    object LugarTuristicoMainSC : Destinations(
        "lugarturisticomain",
        "Adm. Lugares Turísticos",
        Icons.Filled.DateRange
    )

    object LugarTuristicoFormSC : Destinations(
        "formularioLugarTuristico?lugarId={lugarId}",
        "Form Lugar Turístico",
        Icons.Filled.Add
    ) {
        fun createRoute(lugarId: Long?): String {
            return "formularioLugarTuristico?lugarId=$lugarId"
        }
    }
